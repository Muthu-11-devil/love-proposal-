...
function startCountdown(dateValue) {
    ...
    function updateCountdown() {
        ...
        document.getElementById("countdownMessage").textContent =
            "💕 Every second brings you closer to a beautiful day!";
...
function answerYes() {
    ...
    document.getElementById("answerMessage").textContent =
        "💖 That's a beautiful answer! Wishing you many happy moments together! 💕";
...
function answerMaybe() {
    ...
    document.getElementById("answerMessage").textContent =
        "💕 Take your time. Every beautiful story has its own pace.";
...
const puzzles = [
    {
        question: "What is the opposite of hate? ❤️",
        answer: "love"
    },
    {
        question: "How many hearts are in this word: ❤️❤️❤️ ?",
        answer: "3"
    },
    {
        question: "Complete this: Love is _____. 💕",
        answer: "beautiful"
    }
];
...
function showPuzzle(){
    ...
    if(puzzleLevel >= puzzles.length){
        ...
        document.getElementById("puzzleQuestion").textContent =
            "🎉 All puzzles unlocked! Your love story is ready!";

        document.getElementById("puzzleAnswer").style.display =
            "none";
...
function checkPuzzle(){
    ...
    if(answer === puzzles[puzzleLevel].answer){

        puzzleLevel++;

        document.getElementById("puzzleMessage").textContent =
            "🔓 Correct! You unlocked the next level! ❤️";
